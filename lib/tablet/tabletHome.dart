...
class _tabletHomeState extends State<tabletHome> {
  ...
  Future<String> fetchTodaysEventsEng() async {
    final response =
        await http.get(Uri.parse(global.apiAddress + 'GetTodaysEventsEng'));
  ...
  Future<List<EventModel>> fetchEventsEng() async {
    final responseEng = await http
        .get(Uri.parse(global.apiAddress + 'GetAllUpcomingEventsEng'));
  ...
  Future<List<EventModel>> fetchEventsArb() async {
    final responseArb = await http
        .get(Uri.parse(global.apiAddress + 'GetAllUpcomingEventsArb'));
                                            ...
                                            builder: (context, snapshot) {
                                              if (snapshot.hasData) {
                                                return InkWell(
                                                  ...
                                                  child: Text(
                                                    "${snapshot.data.toString().tr()} events today"
                                                        .tr(),
                                                    style: GoogleFonts.barlow(
                                                      textStyle: TextStyle(
                                                          color:
                                        ...
                                        child: Row(
                                          children: [
                                            ...
                                            GroupButton(
                                              ...
                                              selectedColor: const Color(0xFFBD9B60),
